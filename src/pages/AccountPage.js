  ...
  return (
    <PageWrapper>
      <ContentWrapper>
        ...
        <Header>
          <RowBetween>
            <span>
              ...
              <Link lineHeight={'145.23%'} href={'https://www.oklink.com/okexchain/address/' + account} target="_blank">
                <TYPE.main fontSize={14}>{t("View on oklink")}</TYPE.main>
              </Link>
            </span>
            <AccountWrapper>
              <StyledIcon>
        ...
        <DashboardWrapper>
          {showWarning && <Warning>{t('Fees cannot currently be calculated for pairs that include AMPL.')}</Warning>}
          {!hideLPContent && (
            <DropdownWrapper>
          ...
          {!hideLPContent && (
            <Panel style={{ height: '100%', marginBottom: '1rem' }}>
              <AutoRow gap="20px">
                <AutoColumn gap="10px">
                  <RowBetween>
                    <TYPE.body>{t('Liquidity')} {t('including Fees')}</TYPE.body>
                    <div />
                  </RowBetween>
                ...
                <AutoColumn gap="10px">
                  <RowBetween>
                    <TYPE.body>{t('Fees Earned')} {t('Cumulative')}</TYPE.body>
                    <div />
                  </RowBetween>
                  <RowFixed align="flex-end">
