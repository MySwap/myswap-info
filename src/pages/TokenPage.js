      ...
      <ContentWrapper>
        <RowBetween style={{ flexWrap: 'wrap', alingItems: 'start' }}>
          <AutoRow align="flex-end" style={{ width: 'fit-content' }}>
            <TYPE.body>
              <BasicLink to="/tokens">{t('Token')}</BasicLink>→ {symbol}
            </TYPE.body>
            <Link
            ...
            <>
              ...
              <PanelWrapper style={{ marginTop: below1080 ? '0' : '1rem' }}>
                ...
                <Panel>
                  <AutoColumn gap="20px">
                    <RowBetween>
                      <TYPE.main>{t('Transactions')} (24H)</TYPE.main>
                      <div />
                    </RowBetween>
                    <RowBetween align="flex-end">
                      <TYPE.main fontSize={'1.5rem'} lineHeight={1} fontWeight={500}>
            ...
            <RowBetween style={{ marginTop: '3rem' }}>
              ...
              <AutoRow gap="4px" style={{ width: 'fit-content' }}>
                <Checkbox
                  ...
                  text={t('Hide untracked pairs')}
                />
                <QuestionHelper text={t('USD amounts may be inaccurate in low liquiidty pairs or pairs without OKT or stablecoins.')} />
              </AutoRow>
            </RowBetween>
            <Panel
              rounded
